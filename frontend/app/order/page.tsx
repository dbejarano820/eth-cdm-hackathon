...
import { TextInput, Metric, Text, Title, NumberInput, Button } from '@tremor/react';
  ...
  return (
    <main className="p-4 md:p-10 mx-auto max-w-7xl">
      ...
      <div className='my-6'>
        ...
        <SelectChain value={selectedChain} setValue={setSelectedChain} disabled={isSubmitting} />
        <div className='my-3'>
      ...
      <Button onClick={handleSubmit} disabled={isSubmitting}>Cobrar</Button>
      {qrCode && !isSubmitting && (
        <div className='my-3'>
          <QRCode value={qrCode} />
        </div>
