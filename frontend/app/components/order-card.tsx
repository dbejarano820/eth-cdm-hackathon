...
import ShoppingCartIcon from '../icons/ShoppingCartIcon';
  ...
  function determineBadge(status: string) {
    switch (status) {
      ...
      case "Completed":
        return <Badge color="green" icon={ShoppingCartIcon}>Completed</Badge>;
      case "Incomplete":
        return <Badge color="red" icon={MagnifyingIcon}>Incomplete</Badge>;
      case "Expired":
        return <Badge color="red" icon={ExpiredIcon}>Expired</Badge>;
      default:
