...
INSERT INTO Users (id, correo, total_balance) VALUES
('1', 'user1@example.com', 1000),
('2', 'user2@example.com', 1500),
('3', 'user3@example.com', 2000);

-- Insert mock data into Wallets
INSERT INTO Wallets (id, user_id, public_key, private_key, blockchain, balance) VALUES
('1', '1', 'pubKey1', 'privKey1', 'Avalanche', 500),
('2', '2', 'pubKey2', 'privKey2', 'Avalanche', 750),
('3', '3', 'pubKey3', 'privKey3', 'Avalanche', 300);
